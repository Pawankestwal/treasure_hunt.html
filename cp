...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  const passwords=["pirate","treasure"];
  const riddleText=`Garmi aaye toh sabki haalat ho jaaye kharaab,
Par ek dost hai jo kare sabko lajawab.

Hawa uski thandi, style hai smarty,
Naam sunte hi mile cooling ki guarantee — Verti!

Deewar pe lage, chale bina shor,
Ghar ko bana de ek thanda sa floor.

Main toh is company ke dil ke bilkul paas hoon,
Har season mein deta hoon sukoon ka vishwas hoon.

Batao kaun`;
  const imageURL="https://raw.githubusercontent.com/Pawankestwal/treasure_hunt.html/main/Images/WhatsApp Image 2025-09-07 at 23.33.41_c834442c.jpg";
